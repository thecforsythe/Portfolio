...
var webDesignLibrary = [

  {
    ...
    title:                '<p class="pNoPadding">Check In: A Better Way to Travel</p>',
    url:                'https://dustinyschild.github.io/hotel-final-project/index.html',
    date:                 '<p class="pNoPadding">6-30-2017</p>',
  ...
  },
  {
    ...
    title:                '<p class="pNoPadding">Bus Mall</p>',
    url:                  'https://thecforsythe.github.io/busMall/',
    date:                 '<p class="pNoPadding">6-23-2017</p>',
  ...
  },
  {
    ...
    title:                '<p class="pNoPadding">About Me</p>',
    url:                  'https://thecforsythe.github.io/About-Me/',
    date:                 '<p class="pNoPadding">6-9-2017</p>',
